        ...
        return new OpenAPI()
                .components(new Components()
                        .addSecuritySchemes("bearerAuth", new SecurityScheme()
                                ...
                                .bearerFormat("JWT")))
                .info(new Info()
                        .title("Authentication management API of CrediYa")
                        .description("API that provides services for the management, administration and control of Users of CrediYa")
                        .version("v0.0.1"))
